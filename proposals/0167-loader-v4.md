...
- Behavior:
  ...
  - Check that the provided authority is either the migration authority
  (pubkey is `3Scf35jMNk2xXBD6areNjgMtXgp5ZspDhms8vdcbzC42`) or the upgrade
  authority stored in the program data account,
  otherwise throw `IncorrectAuthority`
  ...
  - otherwise, if the program data account was not finalized and the migration
  authority (as opposed to the upgrade authority) was provided:
